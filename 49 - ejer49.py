...
REVISION DEL EJERCICIO ANTERIOR SIN DEFINIR EL METODO CONSTRUCTOR
SINO CON INIT QUE FUNCIONA COMO CONSTRUCTOR.
"""
class Persona:
...
for i in range(3):
    ...
    fuente_nombre[i] = Persona(nombre,apellidos,edad)
